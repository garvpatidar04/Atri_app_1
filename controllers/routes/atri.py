...
class Atri:
	def __init__(self, state: Any):
		...
		self.outer_head = state["outer_head"]
		self.inner_head = state["inner_head"]
		self.logo = state["logo"]
		self.menu = state["menu"]
		self.Flex_book_call = state["Flex_book_call"]
		...
		self.Download_flexbox = state["Download_flexbox"]
		self.Div3 = state["Div3"]
		self.trusted_section = state["trusted_section"]
		self.trusted_inner_flex = state["trusted_inner_flex"]
		self.Div7 = state["Div7"]
		self.Flex11 = state["Flex11"]
		self.Services = state["Services"]
		self.wrapper_services = state["wrapper_services"]
		self.Heading_services_wrapper = state["Heading_services_wrapper"]
		self.Service_flex = state["Service_flex"]
		self.service_1 = state["service_1"]
		self.service_1_inner_heading = state["service_1_inner_heading"]
		self.Flex18 = state["Flex18"]
		self.service_2 = state["service_2"]
		self.Flex22 = state["Flex22"]
		self.Flex21 = state["Flex21"]
		self.service_3 = state["service_3"]
		self.Flex25 = state["Flex25"]
		self.Flex24 = state["Flex24"]
		self.project_heading = state["project_heading"]
		self.wrapper_heading = state["wrapper_heading"]
		self.Div16 = state["Div16"]
		self.Div18 = state["Div18"]
		self.Slider_flex = state["Slider_flex"]
		self.Div19 = state["Div19"]
		self.carousel_description_flex = state["carousel_description_flex"]
		self.Flex29 = state["Flex29"]
		self.blog_section = state["blog_section"]
		self.wrapper_blog_flex = state["wrapper_blog_flex"]
		self.left_side = state["left_side"]
		self.Flex36 = state["Flex36"]
		self.right_side_flex = state["right_side_flex"]
		self.blog_1 = state["blog_1"]
		self.blog_1_inner_flex = state["blog_1_inner_flex"]
		self.Flex38 = state["Flex38"]
		self.blog_3_inner_flex = state["blog_3_inner_flex"]
		self.Flex41 = state["Flex41"]
		self.blog_2_inner_flex = state["blog_2_inner_flex"]
		self.Flex45 = state["Flex45"]
		self.blog_4_inner_flex = state["blog_4_inner_flex"]
		self.Flex47 = state["Flex47"]
		self.blog_5_inner_flex = state["blog_5_inner_flex"]
		self.Flex51 = state["Flex51"]
		self.About_section = state["About_section"]
		self.wrapper_about = state["wrapper_about"]
		self.Flex54 = state["Flex54"]
		self.Flex55 = state["Flex55"]
		self.prdct_preview_section = state["prdct_preview_section"]
		self.wrapper_img_flex = state["wrapper_img_flex"]
		self.horizontal_flex = state["horizontal_flex"]
		self.vertical_flex = state["vertical_flex"]
		self.Experience_section = state["Experience_section"]
		self.wrapper_flex_experience = state["wrapper_flex_experience"]
		self.left_wrapper_flex = state["left_wrapper_flex"]
		...
		self.right_wrapper_flex = state["right_wrapper_flex"]
		...
		self.wrapper_flex = state["wrapper_flex"]
		...
		self.wrapper_footer_flex = state["wrapper_footer_flex"]
		...
		self.project_box = state["project_box"]
		self.services_box = state["services_box"]
		self.book_call_box = state["book_call_box"]
		self.side_arrow = state["side_arrow"]
		...
		self.My_photo = state["My_photo"]
		self.TextBox10 = state["TextBox10"]
		self.Logo_ipsum_4 = state["Logo_ipsum_4"]
		self.Logo_ipsum_1 = state["Logo_ipsum_1"]
		self.Logo_ipsum_2 = state["Logo_ipsum_2"]
		self.Logo_ipsum_3 = state["Logo_ipsum_3"]
		self.Top_heading = state["Top_heading"]
	...
	@property
	def outer_head(self):
		self._getter_access_tracker["outer_head"] = {}
		return self._outer_head
	@outer_head.setter
	def outer_head(self, new_state):
		self._setter_access_tracker["outer_head"] = {}
		global default_state
		self._outer_head = Flex(new_state, default_state["outer_head"])

	@property
	def inner_head(self):
		self._getter_access_tracker["inner_head"] = {}
		return self._inner_head
	@inner_head.setter
	def inner_head(self, new_state):
		self._setter_access_tracker["inner_head"] = {}
		global default_state
		self._inner_head = Flex(new_state, default_state["inner_head"])
	...
	@property
	def Flex_book_call(self):
		self._getter_access_tracker["Flex_book_call"] = {}
		return self._Flex_book_call
	@Flex_book_call.setter
	def Flex_book_call(self, new_state):
		self._setter_access_tracker["Flex_book_call"] = {}
		global default_state
		self._Flex_book_call = Flex(new_state, default_state["Flex_book_call"])
	...
	@property
	def Download_flexbox(self):
		self._getter_access_tracker["Download_flexbox"] = {}
		return self._Download_flexbox
	@Download_flexbox.setter
	def Download_flexbox(self, new_state):
		self._setter_access_tracker["Download_flexbox"] = {}
		global default_state
		self._Download_flexbox = Flex(new_state, default_state["Download_flexbox"])
	...
	@property
	def trusted_section(self):
		self._getter_access_tracker["trusted_section"] = {}
		return self._trusted_section
	@trusted_section.setter
	def trusted_section(self, new_state):
		self._setter_access_tracker["trusted_section"] = {}
		global default_state
		self._trusted_section = Div(new_state, default_state["trusted_section"])

	@property
	def trusted_inner_flex(self):
		self._getter_access_tracker["trusted_inner_flex"] = {}
		return self._trusted_inner_flex
	@trusted_inner_flex.setter
	def trusted_inner_flex(self, new_state):
		self._setter_access_tracker["trusted_inner_flex"] = {}
		global default_state
		self._trusted_inner_flex = Flex(new_state, default_state["trusted_inner_flex"])
	...
	@property
	def wrapper_services(self):
		self._getter_access_tracker["wrapper_services"] = {}
		return self._wrapper_services
	@wrapper_services.setter
	def wrapper_services(self, new_state):
		self._setter_access_tracker["wrapper_services"] = {}
		global default_state
		self._wrapper_services = Flex(new_state, default_state["wrapper_services"])

	@property
	def Heading_services_wrapper(self):
		self._getter_access_tracker["Heading_services_wrapper"] = {}
		return self._Heading_services_wrapper
	@Heading_services_wrapper.setter
	def Heading_services_wrapper(self, new_state):
		self._setter_access_tracker["Heading_services_wrapper"] = {}
		global default_state
		self._Heading_services_wrapper = Div(new_state, default_state["Heading_services_wrapper"])

	@property
	def Service_flex(self):
		self._getter_access_tracker["Service_flex"] = {}
		return self._Service_flex
	@Service_flex.setter
	def Service_flex(self, new_state):
		self._setter_access_tracker["Service_flex"] = {}
		global default_state
		self._Service_flex = Flex(new_state, default_state["Service_flex"])

	@property
	def service_1(self):
		self._getter_access_tracker["service_1"] = {}
		return self._service_1
	@service_1.setter
	def service_1(self, new_state):
		self._setter_access_tracker["service_1"] = {}
		global default_state
		self._service_1 = Flex(new_state, default_state["service_1"])

	@property
	def service_1_inner_heading(self):
		self._getter_access_tracker["service_1_inner_heading"] = {}
		return self._service_1_inner_heading
	@service_1_inner_heading.setter
	def service_1_inner_heading(self, new_state):
		self._setter_access_tracker["service_1_inner_heading"] = {}
		global default_state
		self._service_1_inner_heading = Flex(new_state, default_state["service_1_inner_heading"])
	...
	@property
	def service_2(self):
		self._getter_access_tracker["service_2"] = {}
		return self._service_2
	@service_2.setter
	def service_2(self, new_state):
		self._setter_access_tracker["service_2"] = {}
		global default_state
		self._service_2 = Flex(new_state, default_state["service_2"])
	...
	@property
	def service_3(self):
		self._getter_access_tracker["service_3"] = {}
		return self._service_3
	@service_3.setter
	def service_3(self, new_state):
		self._setter_access_tracker["service_3"] = {}
		global default_state
		self._service_3 = Flex(new_state, default_state["service_3"])
	...
	def project_heading(self, new_state):
		...
		global default_state
		self._project_heading = Div(new_state, default_state["project_heading"])

	@property
	def wrapper_heading(self):
		self._getter_access_tracker["wrapper_heading"] = {}
		return self._wrapper_heading
	@wrapper_heading.setter
	def wrapper_heading(self, new_state):
		self._setter_access_tracker["wrapper_heading"] = {}
		global default_state
		self._wrapper_heading = Flex(new_state, default_state["wrapper_heading"])
	...
	@property
	def carousel_description_flex(self):
		self._getter_access_tracker["carousel_description_flex"] = {}
		return self._carousel_description_flex
	@carousel_description_flex.setter
	def carousel_description_flex(self, new_state):
		self._setter_access_tracker["carousel_description_flex"] = {}
		global default_state
		self._carousel_description_flex = Flex(new_state, default_state["carousel_description_flex"])
	...
	@property
	def wrapper_blog_flex(self):
		self._getter_access_tracker["wrapper_blog_flex"] = {}
		return self._wrapper_blog_flex
	@wrapper_blog_flex.setter
	def wrapper_blog_flex(self, new_state):
		self._setter_access_tracker["wrapper_blog_flex"] = {}
		global default_state
		self._wrapper_blog_flex = Flex(new_state, default_state["wrapper_blog_flex"])

	@property
	def left_side(self):
		self._getter_access_tracker["left_side"] = {}
		return self._left_side
	@left_side.setter
	def left_side(self, new_state):
		self._setter_access_tracker["left_side"] = {}
		global default_state
		self._left_side = Flex(new_state, default_state["left_side"])
	...
	@property
	def right_side_flex(self):
		self._getter_access_tracker["right_side_flex"] = {}
		return self._right_side_flex
	@right_side_flex.setter
	def right_side_flex(self, new_state):
		self._setter_access_tracker["right_side_flex"] = {}
		global default_state
		self._right_side_flex = Flex(new_state, default_state["right_side_flex"])

	@property
	def blog_1(self):
		self._getter_access_tracker["blog_1"] = {}
		return self._blog_1
	@blog_1.setter
	def blog_1(self, new_state):
		self._setter_access_tracker["blog_1"] = {}
		global default_state
		self._blog_1 = Div(new_state, default_state["blog_1"])

	@property
	def blog_1_inner_flex(self):
		self._getter_access_tracker["blog_1_inner_flex"] = {}
		return self._blog_1_inner_flex
	@blog_1_inner_flex.setter
	def blog_1_inner_flex(self, new_state):
		self._setter_access_tracker["blog_1_inner_flex"] = {}
		global default_state
		self._blog_1_inner_flex = Flex(new_state, default_state["blog_1_inner_flex"])
	...
	@property
	def blog_3_inner_flex(self):
		self._getter_access_tracker["blog_3_inner_flex"] = {}
		return self._blog_3_inner_flex
	@blog_3_inner_flex.setter
	def blog_3_inner_flex(self, new_state):
		self._setter_access_tracker["blog_3_inner_flex"] = {}
		global default_state
		self._blog_3_inner_flex = Flex(new_state, default_state["blog_3_inner_flex"])
	...
	@property
	def blog_2_inner_flex(self):
		self._getter_access_tracker["blog_2_inner_flex"] = {}
		return self._blog_2_inner_flex
	@blog_2_inner_flex.setter
	def blog_2_inner_flex(self, new_state):
		self._setter_access_tracker["blog_2_inner_flex"] = {}
		global default_state
		self._blog_2_inner_flex = Flex(new_state, default_state["blog_2_inner_flex"])
	...
	@property
	def blog_4_inner_flex(self):
		self._getter_access_tracker["blog_4_inner_flex"] = {}
		return self._blog_4_inner_flex
	@blog_4_inner_flex.setter
	def blog_4_inner_flex(self, new_state):
		self._setter_access_tracker["blog_4_inner_flex"] = {}
		global default_state
		self._blog_4_inner_flex = Flex(new_state, default_state["blog_4_inner_flex"])
	...
	@property
	def blog_5_inner_flex(self):
		self._getter_access_tracker["blog_5_inner_flex"] = {}
		return self._blog_5_inner_flex
	@blog_5_inner_flex.setter
	def blog_5_inner_flex(self, new_state):
		self._setter_access_tracker["blog_5_inner_flex"] = {}
		global default_state
		self._blog_5_inner_flex = Flex(new_state, default_state["blog_5_inner_flex"])
	...
	@property
	def wrapper_about(self):
		self._getter_access_tracker["wrapper_about"] = {}
		return self._wrapper_about
	@wrapper_about.setter
	def wrapper_about(self, new_state):
		self._setter_access_tracker["wrapper_about"] = {}
		global default_state
		self._wrapper_about = Flex(new_state, default_state["wrapper_about"])
	...
	@property
	def prdct_preview_section(self):
		self._getter_access_tracker["prdct_preview_section"] = {}
		return self._prdct_preview_section
	@prdct_preview_section.setter
	def prdct_preview_section(self, new_state):
		self._setter_access_tracker["prdct_preview_section"] = {}
		global default_state
		self._prdct_preview_section = Flex(new_state, default_state["prdct_preview_section"])

	@property
	def wrapper_img_flex(self):
		self._getter_access_tracker["wrapper_img_flex"] = {}
		return self._wrapper_img_flex
	@wrapper_img_flex.setter
	def wrapper_img_flex(self, new_state):
		self._setter_access_tracker["wrapper_img_flex"] = {}
		global default_state
		self._wrapper_img_flex = Flex(new_state, default_state["wrapper_img_flex"])

	@property
	def horizontal_flex(self):
		self._getter_access_tracker["horizontal_flex"] = {}
		return self._horizontal_flex
	@horizontal_flex.setter
	def horizontal_flex(self, new_state):
		self._setter_access_tracker["horizontal_flex"] = {}
		global default_state
		self._horizontal_flex = Flex(new_state, default_state["horizontal_flex"])

	@property
	def vertical_flex(self):
		self._getter_access_tracker["vertical_flex"] = {}
		return self._vertical_flex
	@vertical_flex.setter
	def vertical_flex(self, new_state):
		self._setter_access_tracker["vertical_flex"] = {}
		global default_state
		self._vertical_flex = Flex(new_state, default_state["vertical_flex"])
	...
	@property
	def wrapper_flex_experience(self):
		self._getter_access_tracker["wrapper_flex_experience"] = {}
		return self._wrapper_flex_experience
	@wrapper_flex_experience.setter
	def wrapper_flex_experience(self, new_state):
		self._setter_access_tracker["wrapper_flex_experience"] = {}
		global default_state
		self._wrapper_flex_experience = Flex(new_state, default_state["wrapper_flex_experience"])

	@property
	def left_wrapper_flex(self):
		self._getter_access_tracker["left_wrapper_flex"] = {}
		return self._left_wrapper_flex
	@left_wrapper_flex.setter
	def left_wrapper_flex(self, new_state):
		self._setter_access_tracker["left_wrapper_flex"] = {}
		global default_state
		self._left_wrapper_flex = Flex(new_state, default_state["left_wrapper_flex"])
	...
	@property
	def right_wrapper_flex(self):
		self._getter_access_tracker["right_wrapper_flex"] = {}
		return self._right_wrapper_flex
	@right_wrapper_flex.setter
	def right_wrapper_flex(self, new_state):
		self._setter_access_tracker["right_wrapper_flex"] = {}
		global default_state
		self._right_wrapper_flex = Flex(new_state, default_state["right_wrapper_flex"])
	...
	@property
	def wrapper_flex(self):
		self._getter_access_tracker["wrapper_flex"] = {}
		return self._wrapper_flex
	@wrapper_flex.setter
	def wrapper_flex(self, new_state):
		self._setter_access_tracker["wrapper_flex"] = {}
		global default_state
		self._wrapper_flex = Flex(new_state, default_state["wrapper_flex"])
	...
	@property
	def wrapper_footer_flex(self):
		self._getter_access_tracker["wrapper_footer_flex"] = {}
		return self._wrapper_footer_flex
	@wrapper_footer_flex.setter
	def wrapper_footer_flex(self, new_state):
		self._setter_access_tracker["wrapper_footer_flex"] = {}
		global default_state
		self._wrapper_footer_flex = Flex(new_state, default_state["wrapper_footer_flex"])
	...
	def blog_box(self, new_state):
		...
		global default_state
		self._blog_box = TextBox(new_state, default_state["blog_box"])
	...
	def project_box(self):
		self._getter_access_tracker["project_box"] = {}
		return self._project_box
	@project_box.setter
	def project_box(self, new_state):
		self._setter_access_tracker["project_box"] = {}
		global default_state
		self._project_box = TextBox(new_state, default_state["project_box"])

	@property
	def services_box(self):
		self._getter_access_tracker["services_box"] = {}
		return self._services_box
	@services_box.setter
	def services_box(self, new_state):
		self._setter_access_tracker["services_box"] = {}
		global default_state
		self._services_box = TextBox(new_state, default_state["services_box"])

	@property
	def book_call_box(self):
		self._getter_access_tracker["book_call_box"] = {}
		return self._book_call_box
	@book_call_box.setter
	def book_call_box(self, new_state):
		self._setter_access_tracker["book_call_box"] = {}
		global default_state
		self._book_call_box = TextBox(new_state, default_state["book_call_box"])

	@property
	def side_arrow(self):
		self._getter_access_tracker["side_arrow"] = {}
		return self._side_arrow
	@side_arrow.setter
	def side_arrow(self, new_state):
		self._setter_access_tracker["side_arrow"] = {}
		global default_state
		self._side_arrow = Image(new_state, default_state["side_arrow"])
	...
	@property
	def My_photo(self):
		self._getter_access_tracker["My_photo"] = {}
		return self._My_photo
	@My_photo.setter
	def My_photo(self, new_state):
		self._setter_access_tracker["My_photo"] = {}
		global default_state
		self._My_photo = Image(new_state, default_state["My_photo"])
	...
	@property
	def Logo_ipsum_4(self):
		self._getter_access_tracker["Logo_ipsum_4"] = {}
		return self._Logo_ipsum_4
	@Logo_ipsum_4.setter
	def Logo_ipsum_4(self, new_state):
		self._setter_access_tracker["Logo_ipsum_4"] = {}
		global default_state
		self._Logo_ipsum_4 = Image(new_state, default_state["Logo_ipsum_4"])

	@property
	def Logo_ipsum_1(self):
		self._getter_access_tracker["Logo_ipsum_1"] = {}
		return self._Logo_ipsum_1
	@Logo_ipsum_1.setter
	def Logo_ipsum_1(self, new_state):
		self._setter_access_tracker["Logo_ipsum_1"] = {}
		global default_state
		self._Logo_ipsum_1 = Image(new_state, default_state["Logo_ipsum_1"])

	@property
	def Logo_ipsum_2(self):
		self._getter_access_tracker["Logo_ipsum_2"] = {}
		return self._Logo_ipsum_2
	@Logo_ipsum_2.setter
	def Logo_ipsum_2(self, new_state):
		self._setter_access_tracker["Logo_ipsum_2"] = {}
		global default_state
		self._Logo_ipsum_2 = Image(new_state, default_state["Logo_ipsum_2"])

	@property
	def Logo_ipsum_3(self):
		self._getter_access_tracker["Logo_ipsum_3"] = {}
		return self._Logo_ipsum_3
	@Logo_ipsum_3.setter
	def Logo_ipsum_3(self, new_state):
		self._setter_access_tracker["Logo_ipsum_3"] = {}
		global default_state
		self._Logo_ipsum_3 = Image(new_state, default_state["Logo_ipsum_3"])

	@property
	def Top_heading(self):
		self._getter_access_tracker["Top_heading"] = {}
		return self._Top_heading
	@Top_heading.setter
	def Top_heading(self, new_state):
		self._setter_access_tracker["Top_heading"] = {}
		global default_state
		self._Top_heading = TextBox(new_state, default_state["Top_heading"])
	...
	def sub_heading(self, new_state):
		...
		global default_state
		self._sub_heading = TextBox(new_state, default_state["sub_heading"])
	...
	def _to_json_fields(self):
		return {
			"outer_head": self._outer_head,
			"inner_head": self._inner_head,
			"logo": self._logo,
			"menu": self._menu,
			"Flex_book_call": self._Flex_book_call,
			...
			"Div5": self._Div5,
			"Flex8": self._Flex8,
			"Download_flexbox": self._Download_flexbox,
			"Div3": self._Div3,
			"trusted_section": self._trusted_section,
			"trusted_inner_flex": self._trusted_inner_flex,
			"Div7": self._Div7,
			"Flex11": self._Flex11,
			"Services": self._Services,
			"wrapper_services": self._wrapper_services,
			"Heading_services_wrapper": self._Heading_services_wrapper,
			"Service_flex": self._Service_flex,
			"service_1": self._service_1,
			"service_1_inner_heading": self._service_1_inner_heading,
			"Flex18": self._Flex18,
			"service_2": self._service_2,
			"Flex22": self._Flex22,
			"Flex21": self._Flex21,
			"service_3": self._service_3,
			"Flex25": self._Flex25,
			"Flex24": self._Flex24,
			"project_heading": self._project_heading,
			"wrapper_heading": self._wrapper_heading,
			"Div16": self._Div16,
			"Div18": self._Div18,
			"Slider_flex": self._Slider_flex,
			"Div19": self._Div19,
			"carousel_description_flex": self._carousel_description_flex,
			"Flex29": self._Flex29,
			"blog_section": self._blog_section,
			"wrapper_blog_flex": self._wrapper_blog_flex,
			"left_side": self._left_side,
			"Flex36": self._Flex36,
			"right_side_flex": self._right_side_flex,
			"blog_1": self._blog_1,
			"blog_1_inner_flex": self._blog_1_inner_flex,
			"Flex38": self._Flex38,
			"blog_3_inner_flex": self._blog_3_inner_flex,
			"Flex41": self._Flex41,
			"blog_2_inner_flex": self._blog_2_inner_flex,
			"Flex45": self._Flex45,
			"blog_4_inner_flex": self._blog_4_inner_flex,
			"Flex47": self._Flex47,
			"blog_5_inner_flex": self._blog_5_inner_flex,
			"Flex51": self._Flex51,
			"About_section": self._About_section,
			"wrapper_about": self._wrapper_about,
			"Flex54": self._Flex54,
			"Flex55": self._Flex55,
			"prdct_preview_section": self._prdct_preview_section,
			"wrapper_img_flex": self._wrapper_img_flex,
			"horizontal_flex": self._horizontal_flex,
			"vertical_flex": self._vertical_flex,
			"Experience_section": self._Experience_section,
			"wrapper_flex_experience": self._wrapper_flex_experience,
			"left_wrapper_flex": self._left_wrapper_flex,
			"Flex63": self._Flex63,
			"Flex65": self._Flex65,
			"Flex66": self._Flex66,
			"Flex69": self._Flex69,
			...
			"Flex70": self._Flex70,
			"Flex71": self._Flex71,
			"right_wrapper_flex": self._right_wrapper_flex,
			"Flex64": self._Flex64,
			"Flex76": self._Flex76,
			"Flex78": self._Flex78,
			"Flex77": self._Flex77,
			...
			"wrapper_flex": self._wrapper_flex,
			"Flex89": self._Flex89,
			"Flex90": self._Flex90,
			"Flex92": self._Flex92,
			"Flex94": self._Flex94,
			...
			"footer": self._footer,
			"wrapper_footer_flex": self._wrapper_footer_flex,
			...
			"project_box": self._project_box,
			"services_box": self._services_box,
			"book_call_box": self._book_call_box,
			"side_arrow": self._side_arrow,
			...
			"Image4": self._Image4,
			"My_photo": self._My_photo,
			"TextBox10": self._TextBox10,
			"Logo_ipsum_4": self._Logo_ipsum_4,
			"Logo_ipsum_1": self._Logo_ipsum_1,
			"Logo_ipsum_2": self._Logo_ipsum_2,
			"Logo_ipsum_3": self._Logo_ipsum_3,
			"Top_heading": self._Top_heading,
