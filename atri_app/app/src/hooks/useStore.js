...
const desktopModeProps = {
  ...
  "Home": {
        ...
        "testimonials": [
          {
            ...
            "profile_pic": "/app-assets/word_on_the_street.jpeg"
          },
          {
            "name": "Jennifer Musk",
            ...
            "profile_pic": "/app-assets/testimoniol_jennifer.png"
          }
        ]
      },
      "callbacks": {
    ...
    "logo_img": {
      "custom": {
        "alt": "logo",
        "src": "/app-assets/logo_portfolio_creator.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "side_arrow": {
      "custom": {
        ...
        "src": "/app-assets/side_arrow_Vector.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "My_photo": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/image_of_person.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Logo_ipsum_4": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/logo_ipsum_4.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Logo_ipsum_2": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/logo_ipsum_2.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Logo_ipsum_3": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/logo_ipsum_3.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Carousel1": {
      "custom": {
        ...
        "startTile": 1,
        "imageItems": [
          "/app-assets/branding_soulful_rebrand.png",
          "/app-assets/branding_gorilla.png",
          "/app-assets/product_design_datadash.png",
          "/app-assets/web_design_joggr.png",
          "/app-assets/web_design_maize.png"
        ],
    ...
    "Image16": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/side_arrow_white.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image28": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/working_people_img.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image30": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/tilted_arrow.svg"
      },
      "callbacks": {
        "onClick": [
          {
